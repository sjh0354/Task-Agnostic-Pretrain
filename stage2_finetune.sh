...
WORK_DIR="/inspire/hdd/global_user/gongjingjing-25039/jhshi/nora/training"
CONFIG_FILE="/inspire/hdd/global_user/gongjingjing-25039/jhshi/nora/training/accelerator_config.yaml"
...
if [ $# -lt 2 ]; then
  ...
  echo "Example: $0 libero_10_no_noops /path/to/model"
...
OUTPUT_DIR="/path/to/directory/finetune/$TASK_TYPE/$DATA_MIX/checkpoint_$CHECKPOINT_NUM"
