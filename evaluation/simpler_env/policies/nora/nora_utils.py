...
class Nora:
    ...
    def __init__(
        ...
        try:
            ...
            repo_id = "/inspire/hdd/global_user/gongjingjing-25039/jhshi/nora/download_models/nora"
            filename = "norm_stats.json"

            # Download the norm_stats locally (only downloads once; cached)
            # file_path = hf_hub_download(repo_id=repo_id, filename=filename)
            file_path = "/inspire/hdd/global_user/gongjingjing-25039/jhshi/nora/download_models/nora/norm_stats.json"
