...
Example:
    ...
    python simpler_env/simple_inference_visual_matching_prepackaged_envs.py --policy openvla --task widowx_spoon_on_towel --logging-root ./results_simple_eval/  --n-trajs 10
"""
