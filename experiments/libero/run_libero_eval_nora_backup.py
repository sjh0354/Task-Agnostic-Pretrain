...
Usage:
    ...
    python experiments/libero/run_libero_eval_nora.py \
        --model_family openvla \
        --pretrained_checkpoint "/inspire/hdd/global_user/gongjingjing-25039/jhshi/nora/checkpoint/libero_libero_object_no_noops/libero_object_no_noops/steps_75000" \
...
class GenerateConfig:
    ...
    pretrained_checkpoint: Union[str, Path] = "/inspire/hdd/g"     # Pretrained checkpoint path
...
def eval_libero(cfg: GenerateConfig) -> None:
    ...
    # model = Nora(model_path='declare-lab/nora-finetuned-libero-object')
    model = Nora(model_path="/inspire/hdd/global_user/gongjingjing-25039/jhshi/nora/download_models/nora-long-finetuned-libero-spatial")
